      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Hear from people who have found support and growth through Sahaayak's resources.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Testimonial
            quote="The resources and community at Sahaayak have been instrumental in my recovery journey. I've learned coping strategies that I use every day."
            author="Sarah K."
